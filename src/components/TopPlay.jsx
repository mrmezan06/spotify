...
const TopChartCard = ({
  ...
  <div className="flex flex-row items-center w-full hover:bg-[#4c426e] py-2 p-4 cursor-pointer mb-2">
    ...
    >
      <div className="w-full flex flex-col">
        <div className="flex flex-row justify-between items-center">
          ...
          <Link
            to="/top-charts"
            className="text-gray-300 text-base cursor-pointer hover:text-white"
          >
            <p>See more</p>
          </Link>
        </div>
